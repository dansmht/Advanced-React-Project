...
describe("Modal", () => {
  ...
  it("should not render if isOpen prop is false", () => {
    renderComponent(<Modal isOpen={false} title="Modal Header" onClose={onClose}>Modal Body</Modal>);
    expect(screen.queryByTestId("modal-overlay")).not.toBeInTheDocument();
  });

  it("should render if isOpen prop is true", () => {
    renderComponent(<Modal isOpen={true} title="Title" onClose={onClose}>Body</Modal>);
